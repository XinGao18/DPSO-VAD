...
# data enhancement by using multi-crop and flipping
...
if __name__ == '__main__':
    # Preprocess the video and save it as .npy file
    video = np.zeros([3, 320, 240, 3], dtype=np.uint8) # fake video data
