"""
UCF-Crime Dataset Test Script - DPSOVAD Version

Evaluate DPSOVAD model on UCF-Crime test set, computing AUC and AP metrics.
...
def test(model, testdataloader, maxlen, prompt_text, gt, gtsegments, gtlabels, device):
    """
    Test DPSOVAD model performance on UCF-Crime dataset
    ...
    # Compute AUC and AP
    print("\n" + "="*60)
    print("DPSOVAD Evaluation Results - UCF-Crime Test Set")
    print("="*60)
...
if __name__ == '__main__':
    ...
    args = ucf_option_dpsovad.parser.parse_args()

    # UCF-Crime label mapping
    label_map = dict({
        'Normal': 'Normal',
        'Abuse': 'Abuse',
        'Arrest': 'Arrest',
